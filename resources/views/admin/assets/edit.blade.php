                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.assets.update", [$asset->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('register') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="register" id="register" value="{{ old('register', $asset->register) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('merk') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="merk" id="merk" value="{{ old('merk', $asset->merk) }}">
                            @if($errors->has('merk'))
                        ...
                        <div class="form-group {{ $errors->has('ukuran') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ukuran" id="ukuran" value="{{ old('ukuran', $asset->ukuran) }}">
                        ...
                        <div class="form-group {{ $errors->has('bahan') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="bahan" id="bahan" value="{{ old('bahan', $asset->bahan) }}">
                            @if($errors->has('bahan'))
                        ...
                        <div class="form-group {{ $errors->has('pemebelian') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="pemebelian" id="pemebelian" value="{{ old('pemebelian', $asset->pemebelian) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('perolehan') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="perolehan" id="perolehan" value="{{ old('perolehan', $asset->perolehan) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('harga') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="harga" id="harga" value="{{ old('harga', $asset->harga) }}" step="0.01" required>
                            @if($errors->has('harga'))
                        ...
                        <div class="form-group {{ $errors->has('sub_lokasi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="sub_lokasi" id="sub_lokasi" value="{{ old('sub_lokasi', $asset->sub_lokasi) }}">
                        ...
                        <div class="form-group {{ $errors->has('lantai') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="lantai" id="lantai" value="{{ old('lantai', $asset->lantai) }}">
                        ...
                        <div class="form-group {{ $errors->has('assigned_to') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="penanggung_jawab" id="penanggung_jawab" value="{{ old('penanggung_jawab', $asset->penanggung_jawab) }}">
                        ...
                        <div class="form-group {{ $errors->has('perintah') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="perintah" id="perintah" value="{{ old('perintah', $asset->perintah) }}">
                        ...
                        <div class="form-group {{ $errors->has('disposisi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="disposisi" id="disposisi" value="{{ old('disposisi', $asset->disposisi) }}">
